...
안녕하세요, 여러분. 강화학습 다섯 번째 시간입니다. 오늘은 정책 경사(Policy Gradient)에 대해 심도 있게 다루는 시간을 갖겠습니다.

### 참고 자료

수업을 시작하기에 앞서, 오늘 우리가 배울 내용들이 어떤 거인들의 어깨 위에 서 있는지 잠시 짚고 넘어가겠습니다. 제 강의 슬라이드와 과제들은 스탠포드 대학의 CS224r, UC 버클리 대학의 CS285, 그리고 구글 딥마인드의 데이비드 실버(David Silver) 교수의 강의 자료를 많이 참고하여 만들어졌습니다. 이 강의들은 강화학습 분야의 초석과도 같은 명강의들이니, 더 깊은 이해를 원한다면 꼭 한번 찾아보시길 권장합니다.

특히 오늘 주제인 정책 경사(Policy Gradient)에 대해서는 Daniel Seita의 블로그 포스트가 아주 정리가 잘 되어 있으니, 오늘 수업이 끝나고 복습하실 때 참고하시면 큰 도움이 될 겁니다.
