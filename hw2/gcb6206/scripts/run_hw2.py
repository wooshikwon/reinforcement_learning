...
from gcb6206.agents.pg_agent import PGAgent
...
def run_training_loop(args):
    ...
    for itr in range(args.n_iter):
        print(f"\n********** Iteration {itr} ************")
        # TODO: sample `args.batch_size` transitions using utils.rollout_trajectories
        # make sure to use `max_ep_len`
        # HINT: `min_timesteps_per_batch`: train batch size.
        ...
        # HINT: check each key in `trajs_dict`
