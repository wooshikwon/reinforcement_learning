...
from gcb6206.env_configs.schedule import (
    LinearSchedule,
    PiecewiseSchedule,
    ConstantSchedule,
)
from gcb6206.infrastructure.atari_wrappers import wrap_deepmind
    ...
    **kwargs,
    ...
    def make_env(render: bool = False):
        return wrap_deepmind(
            gym.make(env_name, frameskip=1, render_mode="rgb_array")
        )
